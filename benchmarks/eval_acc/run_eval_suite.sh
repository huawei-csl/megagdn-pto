...
#
# Wikitext is evaluated on WIKITEXT_LIMIT documents (default: 256).
# Set WIKITEXT_LIMIT=0 to use the full dataset (~40 min per run).
#
# Usage:
...
#   WIKITEXT_LIMIT   Max wikitext docs to evaluate (default: 256)
