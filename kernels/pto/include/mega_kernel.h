...
// guard and the GDN_MAX_HEADS in chunk_cumsum.h.
...
// ===================================================================
// Include the kernel device implementations in separate namespaces.
// Each header holds only device code (no `call_kernel` host wrapper), so the
// namespaces only need to keep the per-kernel helper aliases apart.
// ===================================================================

namespace megagdn_pto {
